...
class Era5MonthlyData(NamedTuple):
    """The monthly data for ERA5 surface and levels data."""
...
def era5_monthly_files(year_to_do : int, month_to_do : int, path_to_era5 : Path) -> dict:

    land_frac_file = path_to_era5 / '2D' / f'{year_to_do:04d}' / f'era5_land_frac_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    orography_file = path_to_era5 / '2D'  / f'{year_to_do:04d}' / f'era5_GEO_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    surf_pressure_file = path_to_era5 / '2D'  / f'{year_to_do:04d}' / f'era5_PS_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    sea_ice_file = path_to_era5 / '2D'  / f'{year_to_do:04d}' / f'era5_SeaIce_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    t2m_file = path_to_era5 / '2D'  / f'{year_to_do:04d}' / f'era5_T2m_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    tdew_file = path_to_era5 / '2D'  / f'{year_to_do:04d}' / f'era5_TDew_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    tskin_file = path_to_era5 / '2D'  / f'{year_to_do:04d}' / f'era5_TSkin_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    w10m_file = path_to_era5 / '2D'  / f'{year_to_do:04d}' / f'era5_W10_2D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'

    cld_file = path_to_era5 / '3D' / f'{year_to_do:04d}' / f'era5_CLD_3D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    geopot_file = path_to_era5 / '3D' / f'{year_to_do:04d}' / f'era5_G_3D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    q_file = path_to_era5 / '3D' / f'{year_to_do:04d}' / f'era5_Q_3D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
    t_file = path_to_era5 / '3D' / f'{year_to_do:04d}' / f'era5_T_3D_360_181_{year_to_do:04d}_{month_to_do:02d}.nc'
